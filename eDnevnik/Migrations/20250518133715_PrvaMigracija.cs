        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoditeljId1 = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AspNetUsers_RoditeljId1",
                        column: x => x.RoditeljId1,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NastavnikId = table.Column<int>(type: "int", nullable: false),
                    NastavnikId1 = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Predmet", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Predmet_AspNetUsers_NastavnikId1",
                        column: x => x.NastavnikId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cas_AspNetUsers_NastavnikId1",
                        column: x => x.NastavnikId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UcenikId1 = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    PredmetId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ocjena_AspNetUsers_UcenikId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UcenikPredmet", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Izostanak_AspNetUsers_UcenikId1",
                        column: x => x.UcenikId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_RoditeljId1",
                table: "AspNetUsers",
                column: "RoditeljId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ocjena_UcenikId1",
                table: "Ocjena",
                column: "UcenikId1");

            migrationBuilder.CreateIndex(
                name: "IX_Predmet_NastavnikId1",
                table: "Predmet",
                column: "NastavnikId1");
